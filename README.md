...
<br>
[Live website](https://horizon-dev.hr/)
...
💾 build single-page or routed apps and websites with React, NextJS, Remix, Astro, PHP or HTML+CSS+JS<br>
...
💾 using frameworks like Chakra UI, Bootstrap, Daisy UI or Tailwind to ensure clean, responsive layouts with custom styling options<br>
<br>
